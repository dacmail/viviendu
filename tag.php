		...
		<div class="row">
			<div id="content" class="col-sm-7">
				<?php while ( have_posts() ) : the_post(); ?>
					<?php $comercio = get_term(get_tax_meta(get_queried_object()->term_id, 'viviendu_comercio'), 'comercio' ); ?>
					<?php $provincia = get_term(get_tax_meta(get_queried_object()->term_id, 'viviendu_provincia'), 'provincia' ); ?>
