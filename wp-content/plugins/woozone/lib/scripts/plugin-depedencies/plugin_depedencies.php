    ...
    class aaTeamPluginDepedencies
    {
	    ...
	    */
		...
		public function depedencies_plugin_redirect_valid() {
			//delete_option('WooZone_depedencies_is_valid');
		...
		public function depedencies_plugin_redirect() {
			...
			delete_option('WooZone_depedencies_do_activation_redirect');
			wp_redirect( get_admin_url() . 'admin.php?page=WooZone' );
		}
		...
		public function verifyDepedencies() {
			...
			<h3 class="WooZone-need-to-install">
			...
			<?php
				...
				$ret['status'] = 'invalid';
			?>
			<div class="WooZone-callout WooZone-callout-danger">
			...
			?>
			<input type="button" value="Re-Check Depedencies" class="WooZone-form-button WooZone-form-button-info WooZone-depedencies-check" style="margin-top: 10px;">
