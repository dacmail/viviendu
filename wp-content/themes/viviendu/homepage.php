...
<div id="container" class="clearfix">
	<section id="featureds" class="container section">
		...
		<p class="subtitle tit-sep">Consulta en Viviendu las propuestas de las principales empresas del sector para descubrir las opciones de casas prefabricadas y viviendas móviles más originales, así como las que ofrecen mayores prestaciones.</p>
	...
	<section class="section" id="whatis">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3">
					<img src="<?php echo asset_path('images/icono_casa.jpg'); ?>" alt="¿Qué es viviendu?">
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 howto-item">
					<img src="<?php echo asset_path('images/search.png'); ?>" alt="Configura">
					<h3 class="title mini">Viviendu para usuarios</h3>
					<div class="text">Consulta en una sola web todas las opciones de casas prefabricadas y viviendas móviles que existen en el mercado. ¡Continuamente ampliamos nuestro directorio con nuevas propuestas! <br><a href="<?php echo get_permalink(7478); ?>">SABER MÁS <i class="fa fa-angle-right"></i></a></div>
				</div>
				<div class="col-md-6 howto-item">
					<img src="<?php echo asset_path('images/statistic.png'); ?>" alt="Configura">
					<h3 class="title mini">Viviendu para empresas</h3>
					<div class="text">Miles de usuarios buscan en Viviendu las mejores propuestas en casas prefabricadas y viviendas móviles. Contacta con potenciales compradores y aumenta tus ventas. <br><a href="<?php echo get_permalink(7476); ?>">SABER MÁS <i class="fa fa-angle-right"></i></a></div>
				</div>
			</div>
		</div>
	</section>
	<section id="secciones" class="container section">
		<div class="row">
			<div class="col-sm-5">
				<?php $list = array('term' => 'provincia', 'class' => 'col-md-4 col-xs-6', 'icon' => 'fa-map-marker', 'args' => array('hide_empty' => 0)); ?>
